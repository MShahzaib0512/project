...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
  	...
  	echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["price"]."</td><td>".$row["image"]."</td><td><a href='adit_chinese.php?id=".$row["id"]."'>Edit</a></td><td><a href='del_chinese.php?id=".$row["id"]. "'>Delete</a></td></tr>";
  }
} else {
  echo "0 results";
}
