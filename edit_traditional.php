...
// 2. pick fron db
$slelect_query = "SELECT * FROM traditional_food";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    </td><td>".$row["image"]."</td><td><a href='adit_traditional.php?id=".$row["id"]."'>
    Edit</a></td><td><a href='del_traditional.php?id=".$row["id"]. "'>Delete</a></td></tr>";
  }
} else {
  echo "0 results";
}
