...
// 2. pick fron db
$slelect_query = "SELECT * FROM spanish_food";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    </td><td>".$row["image"]."</td><td><a href='adit_spanish.php?id=".$row["id"]."'>
    Edit</a></td><td><a href='del_spanish.php?id=".$row["id"]. "'>Delete</a></td></tr>";
  }
} else {
  echo "0 results";
}
